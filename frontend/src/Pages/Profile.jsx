          ...
          <div className="flex items-center gap-2">
            {currentUser?.isAdmin && (
              <NavLink to="/profile/adminpanel">
                <button className="inline-flex items-center gap-1.5 px-4 py-2 bg-amber-50 border border-amber-200 text-amber-700 rounded-lg text-sm font-semibold hover:bg-amber-100 transition-colors">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2 bg-white border border-gray-300 text-gray-600 rounded-lg text-sm font-medium hover:bg-gray-50 transition-colors"
            >
              ...
              <div className="px-6 pb-6 -mt-10">
                <div className="relative inline-block">
                  <img
                    ...
                    alt="Profile"
                    className="w-28 h-28 rounded-xl object-cover border-4 border-white shadow-sm"
                  />
                </div>
                <div className="mt-3">
                  <h2 className="text-lg font-bold text-gray-900">{currentUser.username}</h2>
                  <p className="text-sm text-gray-500 mt-0.5">{currentUser.email}</p>
                  {currentUser?.isAdmin && (
                    <span className="inline-flex items-center gap-1 mt-2 px-2 py-0.5 bg-amber-50 border border-amber-200 text-amber-700 rounded-full text-xs font-medium">
                ...
                <div className="mt-5 grid grid-cols-2 gap-2">
                  <button
                    onClick={handleSignOut}
                    className="flex flex-col items-center justify-center gap-1 p-3 bg-gray-50 border border-gray-200 rounded-lg hover:bg-gray-100 transition-colors group text-center"
                  >
                    <LogOut size={16} className="text-gray-400 group-hover:text-gray-600" />
                    <span className="text-xs font-medium text-gray-500 group-hover:text-gray-700">Logout</span>
                  </button>
                  <button
                    onClick={handleDeleteAccount}
                    className="flex flex-col items-center justify-center gap-1 p-3 bg-gray-50 border border-gray-200 rounded-lg hover:bg-red-50 hover:border-red-200 transition-colors group text-center"
                  >
                    <Trash2 size={16} className="text-gray-400 group-hover:text-red-500" />
                    <span className="text-xs font-medium text-gray-500 group-hover:text-red-600">Delete</span>
                  </button>
                </div>
              </div>
            </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors"
                      />
                    </div>
                  </div>
                  <div>
