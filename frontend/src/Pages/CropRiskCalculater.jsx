          ...
          <div className="lg:col-span-7 bg-white dark:bg-[#09090b] p-6 rounded-xl border border-slate-200 dark:border-zinc-800/80 shadow-sm min-h-[380px] flex flex-col justify-between transition-colors duration-200">
            {loadingRisk ? (
              ...
              <div className="flex flex-col h-full justify-between space-y-6">
                <div>
                  <h2 className="text-sm md:text-base font-semibold text-slate-900 dark:text-white flex items-center gap-2 border-b border-slate-100 dark:border-zinc-800/50 pb-3 mb-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs bg-slate-50 dark:bg-zinc-900/30 border border-slate-200/60 dark:border-zinc-800/80 rounded-xl p-4">
                    <div className="sm:col-span-3 pb-2 border-b border-slate-200/60 dark:border-zinc-800/60 flex items-start gap-1.5">
                      ...
                      <div>
                        <span className="font-semibold text-slate-400 dark:text-zinc-500 text-[10px] block mb-0.5">Boundary Target Location</span>
                    ...
                    <div className="pt-2 sm:pt-0">
                      <span className="font-semibold text-slate-400 dark:text-zinc-500 text-[10px] block mb-0.5">Temperature Baseline</span>
                    ...
                    <div className="pt-2 sm:pt-0">
                      <span className="font-semibold text-slate-400 dark:text-zinc-500 text-[10px] block mb-0.5">Precipitation Scale</span>
                      <p className="text-slate-800 dark:text-zinc-200 font-mono font-bold text-sm flex items-center gap-1">
                ...
                <div>
                  <h3 className="text-xs font-semibold text-slate-400 dark:text-zinc-500 mb-3 flex items-center gap-1.5">
